...
fusion_curvature = a.fusionObjects(
    objects=[mesh, curvature], method="FusionTexSurfMethod"
)
fusion_fundus = a.fusionObjects(
    objects=[mesh, sulcus_fundus], method="FusionTexSurfMethod"
)
