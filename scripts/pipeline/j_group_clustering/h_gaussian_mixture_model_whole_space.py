...
if __name__ == '__main__':
    ...
    for j, side in enumerate(SIDES):
        ...
        path_l = os.path.join(dir_output, 'central_cluster', name + '_' + '_whole_hemisphere_labels' + '.npy')
        path_final_labels = os.path.join(dir_output, d + '_' + 'whole_hemisphere_all_labels' + '_' + side + '.npy')
        ...
        final_labels = sorted_pred_labels
