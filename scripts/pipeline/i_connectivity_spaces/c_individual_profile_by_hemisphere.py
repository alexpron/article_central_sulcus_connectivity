...
if __name__ == '__main__':
    ...
    from configuration.configuration  import SUBJ_LIST, SIDES, PARAMETRISATIONS, HEMI_INDEXES, U_FIBERS_COORD, DENSITIES_RADIUS,U_FIBERS_INDIV_PROFILES, X_GRID, Y_GRID
