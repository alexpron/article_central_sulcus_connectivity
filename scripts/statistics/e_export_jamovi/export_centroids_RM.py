...
if __name__ == "__main__":
    ...
    variables = [
        ...
        "PP_Post_Coord_Iso",
        "PP_CS_Depth",
        "Centroid_Diag_Coord_Iso",
        "Centroid_Orth_Coord_Iso",
        "Centroid_Diag_Coord_Aligned",
        "Centroid_Orth_Coord_Aligned",
        "Centroid_Pre_Coord_Iso",
        "Centroid_Post_Coord_Iso",
        "Centroid_Pre_Coord_Aligned",
        "Centroid_Post_Coord_Aligned",
    ]
    ...
    for label, subdf in final.groupby("Label"):
        subdf.to_csv(
            os.path.join(
                DIR_JAM, "inter", "centroids" + "_" + str(int(label)) + "_" + "RM.csv"
            ),
            index=False,
        )
