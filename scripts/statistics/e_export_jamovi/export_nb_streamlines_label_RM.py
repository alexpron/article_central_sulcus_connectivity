...
if __name__ == '__main__':
    ...
    new_vars_0 = {'Nb_Streamlines_Label_L': 'Nb_Streamlines_Label_L_' + str(0),
                  'Nb_Streamlines_Label_R': 'Nb_Streamlines_Label_R_' + str(0)}
    new_vars_1 = {'Nb_Streamlines_Label_L': 'Nb_Streamlines_Label_L_' + str(1),
                  'Nb_Streamlines_Label_R': 'Nb_Streamlines_Label_R_' + str(1)}
    new_vars_2 = {'Nb_Streamlines_Label_L': 'Nb_Streamlines_Label_L_' + str(2),
                  'Nb_Streamlines_Label_R': 'Nb_Streamlines_Label_R_' + str(2)}
    new_vars_3 = {'Nb_Streamlines_Label_L': 'Nb_Streamlines_Label_L_' + str(3),
                  'Nb_Streamlines_Label_R': 'Nb_Streamlines_Label_R_' + str(3)}
    new_vars_4 = {'Nb_Streamlines_Label_L': 'Nb_Streamlines_Label_L_' + str(4),
