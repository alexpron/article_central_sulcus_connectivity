...
if __name__ == '__main__':
    ...
    df['Centroid_Diag_Coord_Aligned'] = df.groupby(['Hemisphere', 'Subject', 'Label']).transform('mean')['Diag_Coord_Aligned']
    df['Centroid_Orth_Coord_Aligned'] = df.groupby(['Hemisphere', 'Subject', 'Label']).transform('mean')['Orth_Coord_Aligned']
    ...
    df['Centroid_Pre_Coord_Aligned'] = df.groupby(['Hemisphere', 'Subject', 'Label']).transform('mean')['Pre_Coord_Aligned']
    df['Centroid_Post_Coord_Aligned'] = df.groupby(['Hemisphere', 'Subject', 'Label']).transform('mean')['Post_Coord_Aligned']
