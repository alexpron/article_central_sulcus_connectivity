...
if __name__ == '__main__':
    ...
    df = df.drop(columns=['Label','Pre_Coord_Aligned','Pre_Coord_Iso','Post_Coord_Aligned','Post_Coord_Iso','Diag_Coord_Aligned','Orth_Coord_Aligned','Diag_Coord_Iso','Orth_Coord_Iso'])
