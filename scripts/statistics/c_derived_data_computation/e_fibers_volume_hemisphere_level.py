...
if __name__ == '__main__':
    path_df = os.path.join(DIR_IN,'whole_tract_volume.csv')
    ...
    fused_hemi_level = pd.merge(left=hemi_level,right=df, on=['Subject','Hemisphere'])
    fused_hemi_level.to_csv(os.path.join(DIR_JAM, 'streamlines_volume_hemi_level.csv'), index=False )
    ...
    path_df_out = os.path.join(DIR_JAM, 'streamlines_volume_hemi_level_RM.csv')
