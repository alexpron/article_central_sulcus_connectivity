...
if __name__ == '__main__':
    ...
    for name, group in df.groupby('Label'):
        ...
        init_variables = ['Mesh_Area','Fiedler_Length','Roi_Area','Max_Geo_Depth','PP_CS_Depth','FA','MD','RD']
        ...
        path_df_out = os.path.join(DIR_JAM, 'streamlines_DTI_metrics_label_level_' + str(name) + 'RM.csv')
