...
if __name__ == '__main__':
    ...
    sns.heatmap(corr_matrix,mask=mask,annot=True,center=0,square=True,linewidths=0.5,vmin=-1, vmax=1,cmap='Spectral_r',xticklabels=quantitative_variables,yticklabels=quantitative_variables)
    plt.show()
