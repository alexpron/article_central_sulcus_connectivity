...
if __name__ == "__main__":
    ...
    path_hemispheres_index = os.path.join(
        DIR_OUT, "connectivity", "indexes", "hemispheres_index_filtered.npy"
    )
    ...
    for j, side in enumerate(SIDES):
        ...
        path_labels = os.path.join(
            ...
            "group_clustering",
            "dbscan_fixed",
            "global_mean_all_labels_" + side + ".npy",
        )
        ...
        path_density = os.path.join(
            ...
            "densities",
            "group",
            "global_mean_" + side + "_filtered_radius_5.npy",
        )
        ...
        path_fig = os.path.join(
            ...
            "connectivity_space",
            "group_clustering",
            "global_mean_" + side + "_clusters_as_ellipses.tiff",
        )
        density_and_clusters_ellipses(
            X, Y, density, means, cov, vmin=0, vmax=8000, path_fig=path_fig
        )
