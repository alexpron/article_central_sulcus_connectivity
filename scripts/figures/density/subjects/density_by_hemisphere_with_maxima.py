...
import pandas as pd
from libs.figures.connectivity_spaces import density_plot_subject, density_plot_subject_with_maxima
           ...
           for k, name in enumerate(names):
                ...
                if os.path.exists(path_density):
                    ...
                    path_fig = os.path.join(DIR_FIG,'connectivity_space','densities','subjects', subject + '_' + side + \
                                                                                                                '_' +
                                            name + '_' +
                                        'radius' + '_' + str(factor) + '_maxima.png' )

                    density_plot_subject_with_maxima(X,Y,density,pli_passage_subject=None, pli_passage_group=group_pp,
